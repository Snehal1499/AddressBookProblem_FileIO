...
namespace AddressBookProblem
{
    public class BinarySerialization
    {
        ...
        public void Serialization()
        {
            ...
            FileStream fileStream = new FileStream(@"D:\.Net program\AddressBookProblem_FileIO\AddressBookProblem\BinarySerialization.txt", FileMode.Create);
        ...
        {
            FileStream fileStream = new FileStream(@"D:\.Net program\AddressBookProblem_FileIO\AddressBookProblem\BinarySerialization.txt", FileMode.Open);
            BinaryFormatter formatter = new BinaryFormatter();
